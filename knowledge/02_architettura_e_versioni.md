...
| **Cartella Backup Istanze & Mondi** | `C:\Users\nemex\OneDrive\progetti dei frati\accessible games\minecraft archivio backup\backup istanze\` | Sede esclusiva della suite PowerShell per sync e backup `.zip` dei mondi e istanze. |
| **Istanza Attiva PrismLauncher** | `c:\Users\nemex\AppData\Roaming\PrismLauncher\instances\Minecraft 26.2 Access Client\minecraft\` | Ambiente di gioco locale sul PC gaming. |
| **Mod Installata Attiva** | `.../minecraft/mods/minecraft-access-26.2-1.21.0.jar` | File JAR attivo eseguito da PrismLauncher. |
